...
String Sheets_GAS_ID = "AKfycbwW1MonsuDk6bZKR_VuMP0cxzChRMYigNtQIWbjSX_B4sZxuMA";                                         /*This is the Sheets GAS ID, you need to look for your sheets id*/
...
void setup() 
{
  ...
  WIFI_Connect("Cari Wi-Fi","gapunyakuota?");                                                     /*Provide you Wi-Fi SSID and password to connect to Wi-Fi*/
